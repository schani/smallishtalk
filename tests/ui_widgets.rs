...
Transcript showCr: (lp selectAtPoint: (Point x: 3 y: 20)) printString.
Transcript showCr: lp selectedItem.
...
Transcript showCr: (m commandAtPoint: (Point x: 5 y: 17)) printString.
...
"#;
    ...
    // 14-row black bar (rows 17-30) with the glyphs XORed to white — reverse
    // video.
    let expected = "\
........................
........................
